...
const Sidebar = () => {
    ...
    return (
        <>
            <div className='sidebar min-h-[770px]  inline-flex flex-col justify-between bg-slate-100 p-5 pt-5'>
                <div className='top'>
                    <CiMenuBurger
                        onClick={() => setExtended(prev => !prev)} className="text-2xl" />

                    <div className=''>
                        <div onClick={()=>newChat()} className='inline-flex items-center gap-2 mt-8 p-3 bg-white rounded-[50px] font-light text-gray-600 ' >
                            ...
                            <div className='mt-5'>
                                <p className='font-semibold transform'>Recent </p>
                                {
                                    prevPrompts.map((item, index) => {
                                        return (
                                            <>
                                                <div onClick={()=>loadPrompt(item)} className=' inline-flex gap-2 mt-5 hover:bg-gray-300 py-2 px-2 rounded-[50px]'>
